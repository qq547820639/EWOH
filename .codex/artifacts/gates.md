...
| G5 | Backend infrastructure passes | Passed for standalone base | request transaction/GUC, auth, errors, health, rate limit tests; Jest 75 suites / 344 tests |
...
| G7 | Frontend and command map pass | Validation | Playwright smoke: login, command center, command map, devices, alerts render with real data; client Jest 8 suites / 30 tests; work console route and layout type-check |
...
typecheck, lint, Jest 75/344, client 8/30, repo-facts 30/30, OpenAPI 232/232,
