...
| G7 | Frontend and command map pass | Validation | Playwright smoke: login, command center, command map, devices, alerts render with real data; client Jest 11 suites / 37 tests; work console route and layout type-check |
...
typecheck, lint, Jest 76/359, client 11/37, repo-facts 31/31, OpenAPI 232/232,
