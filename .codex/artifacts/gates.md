...
| G5 | Backend infrastructure passes | Passed for standalone base | request transaction/GUC, auth, errors, health, rate limit tests; Jest 76 suites / 349 tests |
...
| G7 | Frontend and command map pass | Validation | Playwright smoke: login, command center, command map, devices, alerts render with real data; client Jest 9 suites / 33 tests; work console route and layout type-check |
...
typecheck, lint, Jest 76/349, client 9/33, repo-facts 31/31, OpenAPI 232/232,
