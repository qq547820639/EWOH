...
- Full server Jest: 79 suites / 383 tests; client Jest: 13 suites / 46 tests;
  typecheck, lint, standalone production build, repo-facts 33/33, OpenAPI
  240/240, and work graph contract audit 20/20 all pass.
...
- Full one-click gate with runtime database: `ALL STANDALONE CHECKS PASSED`
  including E2E 31/31 and browser 4/4; server 79/383, client 13/46,
  OpenAPI 240/240.
