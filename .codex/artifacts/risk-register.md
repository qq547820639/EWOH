...
| R-015 | Offline photo queue and PWA installability still missing | Medium | Online exception photo attachments implemented via `/api/files`; offline queue handles text actions; photo blobs/PWA cache remain follow-ups | Partial AG-07 scenario C |
