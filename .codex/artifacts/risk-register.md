...
| R-015 | Offline photo blob queue still missing | Medium | Online photo attachments via `/api/files` and PWA shell implemented; offline queue handles text actions; photo blob persistence remains a follow-up | Partial AG-07 scenario C |
