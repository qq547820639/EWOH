...
| W7 | P0 hardening: repo-facts gate, unified error contract, data-source vocabulary, transaction reuse, mobile SOP/exception/QC/offline queue/photo/PWA, ValidationPipe, command-map details, state guards, scale idempotency, request-audit correlation, error sanitization | Final 6.0 control plane | standalone-check ALL PASSED; Jest 76/362; client 12/39; OpenAPI 232/232; repo facts 33/33; real PG E2E 29/29 |
