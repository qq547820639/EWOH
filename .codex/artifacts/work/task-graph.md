...
| W7 | P0 hardening: repo-facts gate, unified error contract, data-source vocabulary, transaction reuse, mobile SOP/exception/QC/offline queue, ValidationPipe, command-map details, state guards | Final 6.0 control plane | standalone-check ALL PASSED; Jest 76/355; client 10/35; OpenAPI 232/232 |
