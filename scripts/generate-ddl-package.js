...
const NEW_TABLES = [
  ...
  {
    name: 'ewoh_factory_template',
    domain: 'Scale',
    logicalName: 'ewoh_factory_template',
    businessKey: ['org_id', 'template_id'],
    orgPolicy: 'not_null',
    capabilities: ['scale.template'],
    columns: [
      `template_id varchar(255) NOT NULL UNIQUE`,
      `name varchar(255) NOT NULL`,
    ...
    extraIndexes: [
      `CREATE INDEX IF NOT EXISTS idx_ewoh_factory_template_lifecycle ON ${SCHEMA}.ewoh_factory_template (lifecycle_status);`,
    ],
  },
  {
    name: 'ewoh_factory_profile',
    domain: 'Scale',
    logicalName: 'ewoh_factory_profile',
    businessKey: ['org_id', 'profile_id'],
    orgPolicy: 'not_null',
    capabilities: ['scale.profile'],
    columns: [
    ...
    extraIndexes: [
      `CREATE INDEX IF NOT EXISTS idx_ewoh_factory_profile_status ON ${SCHEMA}.ewoh_factory_profile (status);`,
    ],
  },
  {
    name: 'ewoh_asset_package',
    domain: 'Scale',
    logicalName: 'ewoh_asset_package',
    businessKey: ['org_id', 'package_id'],
    orgPolicy: 'not_null',
    capabilities: ['scale.asset'],
    columns: [
    ...
    extraIndexes: [
      `CREATE INDEX IF NOT EXISTS idx_ewoh_asset_package_type ON ${SCHEMA}.ewoh_asset_package (package_type, status);`,
    ],
  },
];
