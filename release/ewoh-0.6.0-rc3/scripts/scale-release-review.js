...
const version = process.env.EWOH_RELEASE_VERSION || '0.6.0-rc3';
...
const requiredContracts = [
  ...
  'contracts/work/work-graph.schema.json',
  'contracts/work/git-sync-plan.schema.json',
  'contracts/work/artifact-paths.json',
  'contracts/catalog/asset-catalog.schema.json',
  'contracts/factory/factory-profile.schema.json',
  'contracts/factory/replication-report.schema.json',
  'contracts/factory/site-readiness.schema.json',
