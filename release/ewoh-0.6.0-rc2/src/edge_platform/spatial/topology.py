...
class Topology:
    ...
    def to_dict(self):
        return {
            "nodes": [{"node_id": n.node_id, "label": n.label} for n in self._nodes.values()],
            "edges": [
                {"from_id": e.from_id, "to_id": e.to_id, "distance_m": e.distance_m, "route_geojson": e.route_geojson}
                for e in self._edges
            ],
        }
