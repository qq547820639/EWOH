...
class EntityTest(unittest.TestCase):
    ...
    def test_children_ancestors_descendants(self):
        ...
        self.assertEqual([e.entity_id for e in reg.ancestors("S1")], ["Z1", "L1", "WS1", "F1"])
        self.assertEqual({e.entity_id for e in reg.descendants("F1")}, {"WS1", "L1", "Z1", "S1"})
