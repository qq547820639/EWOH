...
| R-015 | Offline photo size limit (~2MB) and compression UX | Low | Offline photo queue implemented via data URLs and flushed to `/api/files` on reconnect; large photos require compression | Partial AG-07 scenario C |
