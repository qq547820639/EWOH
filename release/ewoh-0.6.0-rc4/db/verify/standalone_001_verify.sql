...
nullable_org AS (
  ...
  WHERE c.table_schema = 'public' AND c.table_name = ANY (ARRAY['ewoh_asset_package', 'ewoh_control_command', 'ewoh_control_request', 'ewoh_control_result', 'ewoh_device_binding', 'ewoh_device_capability', 'ewoh_event_action', 'ewoh_event_rule', 'ewoh_event_subscription', 'ewoh_factory_profile', 'ewoh_factory_template', 'ewoh_knowledge_base', 'ewoh_knowledge_entry', 'ewoh_model_asset', 'ewoh_model_binding', 'ewoh_notification', 'ewoh_person_role', 'ewoh_person_skill', 'ewoh_resource_binding', 'ewoh_resource_preorder', 'ewoh_role', 'ewoh_schedule_assignment', 'ewoh_schedule_task', 'ewoh_schedule_task_step', 'ewoh_skill', 'ewoh_spatial_hierarchy', 'ewoh_spatial_relation', 'ewoh_task_skill_req', 'ewoh_task_step', 'ewoh_task_template', 'ewoh_workstation', 'ewoh_workstation_device', 'ewoh_workstation_person', 'ewoh_workstation_relation', 'ewoh_workstation_skill', 'ewoh_scheduler_config', 'ewoh_environment', 'ewoh_model_registry', 'ewoh_schedule_audit', 'ewoh_schedule_plan', 'ewoh_event_chain', 'ewoh_world_state', 'ewoh_topology', 'ewoh_spatial_entity', 'ewoh_telemetry', 'ewoh_event', 'ewoh_device']) AND c.column_name = 'org_id' AND c.is_nullable = 'YES'
),
