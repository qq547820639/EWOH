...
class SettingsDefaultsTest(_EnvIsolatedTest):
    ...
    def test_adapter_ports_default(self):
        s = Settings.load()
        self.assertEqual(s.adapter_ports,
                         {9001: "real", 9002: "controlled_test", 9003: "simulated"})
...
class SettingsEnvOverrideTest(_EnvIsolatedTest):
    def test_env_overrides_port_host_db(self):
        ...
        os.environ["EWOH_DB_PATH"] = "/tmp/ewoh_test.db"
        ...
        self.assertEqual(s.db_path, "/tmp/ewoh_test.db")
