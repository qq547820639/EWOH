...
class RoleEnumTest(unittest.TestCase):
    def test_five_roles(self):
        self.assertEqual(
            ...
            {"admin", "safety_officer", "operator", "data_analyst", "viewer"})
...
class PermissionMatrixTest(unittest.TestCase):
    ...
    def test_viewer_readonly(self):
        ...
        # viewer 不能处置/导出/管理
        for action in (HANDLE_EVENTS, EXPORT_DATA, MANAGE_DEVICES,
                       MANAGE_RULES, MANAGE_MODELS, VIEW_AUDIT, MANAGE_ASSIGNMENTS):
    ...
    def test_safety_officer_permissions(self):
        ...
        for action in (VIEW_TELEMETRY, VIEW_EVENTS, HANDLE_EVENTS,
                       EXPORT_DATA, MANAGE_RULES, MANAGE_MODELS,
                       VIEW_AUDIT, MANAGE_ASSIGNMENTS):
    ...
    def test_operator_permissions(self):
        ...
        for action in (VIEW_TELEMETRY, VIEW_EVENTS, HANDLE_EVENTS,
                       EXPORT_DATA, MANAGE_DEVICES, VIEW_AUDIT):
    ...
    def test_data_analyst_permissions(self):
        ...
        for action in (HANDLE_EVENTS, MANAGE_DEVICES, MANAGE_RULES,
                       MANAGE_MODELS, VIEW_AUDIT, MANAGE_ASSIGNMENTS):
            self.assertFalse(perms[action])
...
class IsAllowedTest(unittest.TestCase):
    def test_enum_and_string_equivalent(self):
        self.assertEqual(
            is_allowed(Role.ADMIN, MANAGE_DEVICES),
            is_allowed("admin", MANAGE_DEVICES))
