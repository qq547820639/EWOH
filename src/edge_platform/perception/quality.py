...
class ConflictDetector:
    ...
    def check(self, person_id, uwb_station, vision_station,
              uwb_conf, vision_conf, uwb_pose=None, vision_pose=None):
        """检查 UWB 与视觉工位归属是否冲突。
        ...
        return SensorConflict(
            ...
            note=("UWB 工位 %s 与视觉工位 %s 不一致" % (uwb_station, vision_station)),
        )
