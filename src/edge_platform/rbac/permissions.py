...
PERMISSIONS = {
    Role.ADMIN.value: {
        VIEW_TELEMETRY: True, VIEW_EVENTS: True, HANDLE_EVENTS: True,
        EXPORT_DATA: True, MANAGE_DEVICES: True, MANAGE_RULES: True,
        MANAGE_MODELS: True, VIEW_AUDIT: True, MANAGE_ASSIGNMENTS: True,
    },
    Role.SAFETY_OFFICER.value: {
        VIEW_TELEMETRY: True, VIEW_EVENTS: True, HANDLE_EVENTS: True,
        EXPORT_DATA: True, MANAGE_DEVICES: False, MANAGE_RULES: True,
        MANAGE_MODELS: True, VIEW_AUDIT: True, MANAGE_ASSIGNMENTS: True,
    },
    Role.OPERATOR.value: {
        VIEW_TELEMETRY: True, VIEW_EVENTS: True, HANDLE_EVENTS: True,
        EXPORT_DATA: True, MANAGE_DEVICES: True, MANAGE_RULES: False,
        MANAGE_MODELS: False, VIEW_AUDIT: True, MANAGE_ASSIGNMENTS: False,
    },
    Role.DATA_ANALYST.value: {
        VIEW_TELEMETRY: True, VIEW_EVENTS: True, HANDLE_EVENTS: False,
        EXPORT_DATA: True, MANAGE_DEVICES: False, MANAGE_RULES: False,
        MANAGE_MODELS: False, VIEW_AUDIT: False, MANAGE_ASSIGNMENTS: False,
    },
    Role.VIEWER.value: {
        VIEW_TELEMETRY: True, VIEW_EVENTS: True, HANDLE_EVENTS: False,
        EXPORT_DATA: False, MANAGE_DEVICES: False, MANAGE_RULES: False,
        MANAGE_MODELS: False, VIEW_AUDIT: False, MANAGE_ASSIGNMENTS: False,
    },
}
