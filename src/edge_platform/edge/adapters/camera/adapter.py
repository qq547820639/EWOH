...
class CameraAdapter(BaseAdapter):
    ...
    def __init__(self, asset, source_type=None, model_version="edge-pose-v0.1"):
        ...
        super().__init__(asset.camera_id, source_type=asset.source_type,
                         model="CAM-GENERIC")
        self.asset = asset
    ...
    def _enqueue_raw(self, raw):
        ...
        try:
            msg = parse_detection(raw, camera_id=self.asset.camera_id,
...
class SimulatedCameraAdapter(CameraAdapter):
    ...
    def __init__(self, camera_id, hz=1.0, model_version="edge-pose-v0.1",
                 source_type="simulated", track_ids=None):
    ...
    def _run(self):
        ...
        while not self._stop_evt.is_set():
            ...
            for i, tid in enumerate(self.track_ids):
                persons.append({
                    "track_id": tid,
                    "skeleton_json": {"version": 1, "keypoints": [
