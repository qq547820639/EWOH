...
def parse_detection(raw, camera_id=None, default_source_type="real",
                    default_model_version="edge-pose-v0.1"):
    ...
    raw_persons = (raw.get("persons") or raw.get("detections")
    ...
    model_version = (raw.get("model_version") or raw.get("model_ver")
