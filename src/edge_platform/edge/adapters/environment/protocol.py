...
def parse_env_reading(raw, default_sensor_id=None, default_station_id=None,
    ...
    has_measure = any(v is not None for v in
                      (temperature_c, vibration_mm_s, noise_db, air_quality_pm25))
