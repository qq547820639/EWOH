...
class MESAdapter(BaseAdapter):
    ...
    def __init__(self, device_id, source_type="real", system_name="MES-GENERIC",
                 protocol_version="1.0"):
        super().__init__(device_id, source_type=source_type, model=system_name,
...
class SimulatedMESAdapter(MESAdapter):
    ...
    DEFAULT_TASKS = [
        {"task_id": "WO-001", "task_name": "月台卸货", "station_id": "STN-DOCK-A",
         "required_skill": "搬运", "load_level": 0.7, "status": "assigned",
         "assigned_person_id": "P-001"},
        {"task_id": "WO-002", "task_name": "产线供料", "station_id": "STN-LINE-1",
         "required_skill": "搬运", "load_level": 0.5, "status": "assigned",
         "assigned_person_id": "P-002"},
        {"task_id": "WO-003", "task_name": "末端装配", "station_id": "STN-ASSY-1",
         "required_skill": "装配", "load_level": 0.4, "status": "started",
         "assigned_person_id": "P-003"},
    ]

    def __init__(self, device_id="MES-SIM", tasks=None, hz=0.5,
