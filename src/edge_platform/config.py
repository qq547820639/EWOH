...
class Settings:
    ...
    def __init__(self):
        ...
        # ---- 适配层 ----
        self.adapter_ports = _parse_adapter_ports(
            os.environ.get("EWOH_ADAPTER_PORTS", _DEFAULT_ADAPTER_PORTS))
        ...
        # ---- 导出权限 ----
        self.export_allowed_roles = _parse_roles(
            os.environ.get("EWOH_EXPORT_ALLOWED_ROLES", _DEFAULT_EXPORT_ROLES))
        # ---- TLS ----
